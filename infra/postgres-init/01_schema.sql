-- Initial schema for medivoice DB (applied automatically on first docker-compose up)
...
CREATE INDEX IF NOT EXISTS idx_conversation_log_session ON conversation_log(session_id, created_at);
